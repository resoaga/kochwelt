...
function updatedIngredient() {
  ...
  if (servings >= 4 && servings <= 20) {
    document.getElementById(
      "potato"
    ).textContent = `${adjustedIngredients3.potato.toFixed(
      0
    )} kg große Kartoffeln, festkochend`;
    document.getElementById(
      "onion"
    ).textContent = `${adjustedIngredients3.onion.toFixed(
      0
    )} Zwiebeln, mittelgroß`;
    document.getElementById(
      "butter"
    ).textContent = `${adjustedIngredients3.butter.toFixed(
      0
    )} EL Butterschmalz`;
    document.getElementById(
      "egg"
    ).textContent = `${adjustedIngredients3.egg.toFixed(0)} Eier`;
    document.getElementById(
      "salt"
    ).textContent = `${adjustedIngredients3.salt.toFixed(0)} Prise Salz`;
  } else {
...
function updateIngredients() {
  ...
  if (servings >= 6 && servings <= 30) {
    ...
    document.getElementById(
      "meat"
    ).textContent = `${adjustedIngredients.meat.toFixed(0)} kg`;
    document.getElementById(
      "oil"
    ).textContent = `${adjustedIngredients.oil.toFixed(0)} EL`;
    document.getElementById(
      "butter"
    ).textContent = `${adjustedIngredients.butter.toFixed(0)} EL`;
    document.getElementById(
      "onions"
    ).textContent = `${adjustedIngredients.onions.toFixed(0)}`;
    document.getElementById(
      "garlic"
    ).textContent = `${adjustedIngredients.garlic.toFixed(0)}`;
    document.getElementById(
      "ham"
    ).textContent = `${adjustedIngredients.ham.toFixed(0)} g`;
    document.getElementById(
      "mushrooms"
    ).textContent = `${adjustedIngredients.mushrooms.toFixed(0)} g`;
    document.getElementById(
      "broth"
    ).textContent = `${adjustedIngredients.broth.toFixed(0)} ml`;
    document.getElementById(
      "cream"
    ).textContent = `${adjustedIngredients.cream.toFixed(0)} ml`;
    document.getElementById(
      "creme_fraiche"
    ).textContent = `${adjustedIngredients.cremeFraiche.toFixed(0)} g`;
    document.getElementById(
      "tomato"
    ).textContent = `${adjustedIngredients.tomatoPaste.toFixed(0)} EL`;
    document.getElementById(
      "mustard"
    ).textContent = `${adjustedIngredients.mustard.toFixed(0)} TL`;
    document.getElementById(
      "parsley"
    ).textContent = `${adjustedIngredients.parsley.toFixed(0)} Bund`;
  } else {
...
function updateIngredient2() {
  ...
  if (servings >= 4 && servings <= 20) {
    ...
    document.querySelector(
      ".amount[data-ingredient='lasagnaPlates']"
    ).textContent = `${adjustedIngredient2.lasagnaPlates} Lasagneplatten`;
    document.querySelector(
      ".amount[data-ingredient='mincedMeat']"
    ).textContent = `${adjustedIngredient2.mincedMeat} g`;
    document.querySelector(
      ".amount[data-ingredient='oliveOil']"
    ).textContent = `${adjustedIngredient2.oliveOil} EL `;
    document.querySelector(
      ".amount[data-ingredient='onion']"
    ).textContent = `${adjustedIngredient2.onion} `;
    document.querySelector(
      ".amount[data-ingredient='garlic']"
    ).textContent = `${adjustedIngredient2.garlic} `;
    document.querySelector(
      ".amount[data-ingredient='tomatoes']"
    ).textContent = `${adjustedIngredient2.tomatoes} g`;
    document.querySelector(
      ".amount[data-ingredient='butter']"
    ).textContent = `${adjustedIngredient2.butter} g`;
    document.querySelector(
      ".amount[data-ingredient='flour']"
    ).textContent = `${adjustedIngredient2.flour} g`;
    document.querySelector(
      ".amount[data-ingredient='milk']"
    ).textContent = `${adjustedIngredient2.milk} ml`;
    document.querySelector(
      ".amount[data-ingredient='cheese']"
    ).textContent = `${adjustedIngredient2.cheese} g `;
  } else {
    alert("Die Portionsmenge sollte min 4 und max 20 betragen.");
  }
}
...
function updateIngredients2() {
  ...
  if (servings >= 12 && servings <= 48) {
    ...
    document.getElementById(
      "wheat"
    ).textContent = `${adjustedIngredients2.wheat.toFixed(0)} g Weizenmehl`;
    document.getElementById("egg").textContent =
      `${adjustedIngredients2.egg.toFixed(0)} ` + `Eier`;
    document.getElementById(
      "oil"
    ).textContent = `${adjustedIngredients2.oil.toFixed(0)} EL Öl`;
    document.getElementById(
      "toast"
    ).textContent = `${adjustedIngredients2.toast.toFixed(0)} Scheiben Toast`;
    document.getElementById(
      "sugar"
    ).textContent = `${adjustedIngredients2.sugar.toFixed(0)} g Zucker`;
    document.getElementById(
      "zimt"
    ).textContent = `${adjustedIngredients2.zimt.toFixed(0)} TL Zimt`;
    document.getElementById(
      "nuts"
    ).textContent = `${adjustedIngredients2.nuts.toFixed(
      0
    )} g gemahlene Haselnüsse`;
    document.getElementById(
      "apple"
    ).textContent = `${adjustedIngredients2.apple.toFixed(0)} kg Äpfel`;
    document.getElementById(
      "citrus"
    ).textContent = `${adjustedIngredients2.citrus.toFixed(0)} EL Zitronensaft`;
    document.getElementById(
      "cranberry"
    ).textContent = `${adjustedIngredients2.cranberry.toFixed(
      0
    )} g getr. Cranberrys`;
    document.getElementById(
      "butter"
    ).textContent = `${adjustedIngredients2.butter.toFixed(
      0
    )} EL geschmolzene Butter`;
    document.getElementById(
      "powderdsugar"
    ).textContent = `${adjustedIngredients2.powderdsugar.toFixed(
      0
    )} EL Puderzucker`;
  } else {
